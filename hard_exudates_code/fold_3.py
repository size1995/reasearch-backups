...
img_path="/home/sz/hard_ex_segmentation/e_dataset/data3/test/img/"
label_path="/home/sz/hard_ex_segmentation/e_dataset/data3/test/label/"

img_root="/home/sz/hard_ex_segmentation/e_dataset/data3/train_crop/img/"
label_root="/home/sz/hard_ex_segmentation/e_dataset/data3/train_crop/label/"
...
sw = SummaryWriter(logdir='./logs_fold3', flush_secs=2)
...
def train(train_data, net, loss, ctx ,global_step,epoch_step, num_epochs,best_F1=0):
    ...
    for epoch in range(num_epochs):
        ...
        if F1>best_F1:
            net.save_parameters('fold_3_sta.params')
            best_F1=F1
