...
img_path="/home/sz/A. Segmentation/1. Original Images/b. Testing Set/"
label_path="/home/sz/A. Segmentation/2. All Segmentation Groundtruths/b. Testing Set/1. Microaneurysms/"

img_root="/home/sz/hard_ex_segmentation/microaneuysms/train_crop/img/"
label_root="/home/sz/hard_ex_segmentation/microaneuysms/train_crop/label/"
...
ctx=[mx.gpu(4),mx.gpu(5),mx.gpu(6)]
...
sw = SummaryWriter(logdir='./logs_micro', flush_secs=2)
...
def train(train_data, net, loss, ctx ,global_step,epoch_step, num_epochs,best_F1=0):
    ...
    for epoch in range(num_epochs):
        ...
        if F1>best_F1:
            net.save_parameters('micro.params')
            best_F1=F1
