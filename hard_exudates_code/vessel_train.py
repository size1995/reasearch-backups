...
img_path="/home/sz/hard_ex_segmentation/vessel_data/val/img/"
label_path="/home/sz/hard_ex_segmentation/vessel_data/val/label/"

img_root="/home/sz/hard_ex_segmentation/vessel_data/train_crop/img/"
label_root="/home/sz/hard_ex_segmentation/vessel_data/train_crop/label/"
...
def train(train_data, net, loss, ctx ,global_step,epoch_step, num_epochs,best_F1=0):
    ...
    for epoch in range(num_epochs):
        ...
        if F1>best_F1:
            net.save_parameters('vessel.params')
            best_F1=F1
