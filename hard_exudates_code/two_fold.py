...
img_path="/home/sz/hard_ex_segmentation/e_dataset/2fold/test/img/"
label_path="/home/sz/hard_ex_segmentation/e_dataset/2fold/test/label/"

img_root="/home/sz/hard_ex_segmentation/e_dataset/2fold/train_crop/img/"
label_root="/home/sz/hard_ex_segmentation/e_dataset/2fold/train_crop/label/"
...
img_root1="/home/sz/hard_ex_segmentation/e_dataset/data3/test_crop/img/"
label_root1="/home/sz/hard_ex_segmentation/e_dataset/data3/test_crop/label/"
...
net.load_parameters('pretrain2.params',ctx=ctx)
net.hybridize()
...
sw = SummaryWriter(logdir='./logs_2fold', flush_secs=2)
...
def train(train_data, net, loss, ctx ,global_step,epoch_step, num_epochs,best_F1=0):
    ...
    for epoch in range(num_epochs):
        ...
        acc_list,tpr_list,tnr_list,ppv_list,ACC,TPR,TNR,PPV,F1=tool.evaluate(img_path,label_path,net,crop_size=256,stride=128,ctx=mx.gpu(4),threshold=0.5)
        ...
        if F1>best_F1:
            net.save_parameters('2fold.params')
            best_F1=F1
        if epoch == 0:
            sw.add_graph(net)
...
"""
train(train_data, net, loss, ctx ,global_step,epoch_step, num_epochs=150,best_F1=0.52)
"""