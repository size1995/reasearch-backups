...
label_path="/home/sz/A. Segmentation/2. All Segmentation Groundtruths/b. Testing Set/2. Haemorrhages/"
img_root="/home/sz/hard_ex_segmentation/heam/train_crop/img/"
label_root="/home/sz/hard_ex_segmentation/heam/train_crop/label/"
...
sw = SummaryWriter(logdir='./logs_heam', flush_secs=2)
...
def train(train_data, net, loss, ctx ,global_step,epoch_step, num_epochs,best_F1=0):
    ...
    for epoch in range(num_epochs):
        ...
        if F1>best_F1:
            net.save_parameters('heam.params')
            best_F1=F1
