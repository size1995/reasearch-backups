...
img_path="/home/sz/hard_ex_segmentation/HEI-MED/data3/test/img/"
label_path="/home/sz/hard_ex_segmentation/HEI-MED/data3/test/label/"

img_root="/home/sz/hard_ex_segmentation/HEI-MED/data3/train_crop/img/"
label_root="/home/sz/hard_ex_segmentation/HEI-MED/data3/train_crop/label/"
...
net.load_parameters('HEI_fold_3.params',ctx=ctx)
...
sw = SummaryWriter(logdir='./HEI_logs_fold3', flush_secs=2)
...
def train(train_data, net, loss, ctx ,global_step,epoch_step, num_epochs,best_F1=0):
    ...
    for epoch in range(num_epochs):
        ...
        if F1>best_F1:
            net.save_parameters('HEI_fold_3.params')
            best_F1=F1
...
train(train_data, net, loss, ctx ,global_step,epoch_step, num_epochs=10,best_F1=0.538)
