...
img_root="/home/sz/hard_ex_segmentation/e_dataset/data3/half_train_crop/img/"

label_root="/home/sz/hard_ex_segmentation/e_dataset/data3/half_train_crop/label/"
...
def train(train_data, net, loss, ctx ,global_step,epoch_step, num_epochs,best_F1=0):
    ...
    for epoch in range(num_epochs):
        ...
        if F1>best_F1:
            net.save_parameters('fold3_1.params')
            best_F1=F1
