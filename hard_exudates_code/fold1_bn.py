...
img_path="/home/sz/hard_ex_segmentation/e_dataset/data1/test/img/"
label_path="/home/sz/hard_ex_segmentation/e_dataset/data1/test/label/"

img_root="/home/sz/hard_ex_segmentation/e_dataset/data1/train_crop/img/"
label_root="/home/sz/hard_ex_segmentation/e_dataset/data1/train_crop/label/"
...
def train(train_data, net, loss, ctx ,global_step,epoch_step, num_epochs,best_F1=0):
    ...
    for epoch in range(num_epochs):
        ...
        if F1>best_F1:
            net.save_parameters('fold_1_bn_att.params')
            best_F1=F1
