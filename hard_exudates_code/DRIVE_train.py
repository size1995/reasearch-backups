...
img_path="/home/sz/hard_ex_segmentation/DRIVE/test/image/"
label_path="/home/sz/hard_ex_segmentation/DRIVE/test/label_png/"

img_root="/home/sz/hard_ex_segmentation/DRIVE/train/train_crop/img/"
label_root="/home/sz/hard_ex_segmentation/DRIVE/train/train_crop/label/"
...
net.load_parameters('vessel.params',ctx=ctx)
...
sw = SummaryWriter(logdir='./vessel', flush_secs=2)
...
def train(train_data, net, loss, ctx ,global_step,epoch_step, num_epochs,best_F1=0):
    ...
    for epoch in range(num_epochs):
        ...
        if F1>best_F1:
            net.save_parameters('DRIVE.params')
            best_F1=F1
